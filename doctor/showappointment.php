...
<div class="container">
<center>
   <h6> Welcome <strong><?php echo $_SESSION["name"]; ?> </strong>here are your pending appointents.</h6> 
</center>
<?php
   }else {
...
<div class="row" style="-webkit-border-radius: 0% 0% 100% 100% / 0% 0% 8px 8px;
   ...
   <div class="col-sm-3">
      <button type="button" class="btn btn-info btn-sm" style="margin-top:29%;" id="mybtn-<?php echo $i; ?>" data-toggle="modal" data-target="#myModal-<?php echo $i; ?>">More Info</button>
   </div>
   <br>
   <!-- Modal -->
