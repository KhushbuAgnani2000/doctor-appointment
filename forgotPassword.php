...
<link rel="stylesheet" href="doctor/forgetpassword.css">
</head>
<body>
	        ...
	        <div class="col-lg-8 col-md-10">
	            ...
	            <form class="card mt-4" method="post">
	                ...
	                <div class="card-footer"> 
						...
						<a class="btn btn-danger" href="PaitentLogin.php">Back to Login</a>
					</div>
	        </div>
	    </div>
	</div>
	<?php
		if(isset($_POST["emailbutton"]))
			{
				$check=mysqli_query($con,"select email from paitent where email='$_POST[email]'");
